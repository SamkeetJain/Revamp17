...
public class CoTPassbookAdapter extends RecyclerView.Adapter<CoTPassbookAdapter.ViewHolder> {
    ...
    public CoTPassbookAdapter(JSONArray jsonArray) {
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                object[i] = jsonObject;
                mPhoneno[i] = jsonObject.getString("Payment_Admin_MobileNo");
                mAmount[i] = jsonObject.getString("Payment_Amounts");
                mDates[i] = jsonObject.getString("Payment_Timestamp");
                mNames[i] = jsonObject.getString("Payment_Admin_Name");
    ...
    @Override
    public CoTPassbookAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
