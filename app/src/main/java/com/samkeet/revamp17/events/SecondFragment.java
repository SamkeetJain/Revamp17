...
public class SecondFragment extends Fragment {
    ...
    private JSONArray technicalevents;
    ...
    public void loadData() {
        ...
        if (Constants.Events.isTechnicalAvalible) {
            ...
            mEventsAdapter = new EventsAdapter(getActivity().getApplicationContext(), Constants.Events.technicalEvents);
    ...
    private class GetEvents extends AsyncTask<Void, Void, Integer> {
        ...
        protected Integer doInBackground(Void... params) {
            try {
                ...
                Uri.Builder _data = new Uri.Builder().appendQueryParameter("Etype", "technical");
                ...
                technicalevents = new JSONArray(jsonResults.toString());
        ...
        protected void onPostExecute(Integer result) {
            ...
            if (errordata) {
                ...
                Constants.Events.technicalEvents = technicalevents;
                Constants.Events.isTechnicalAvalible = true;
                loadData();
            }
